...
$(function(){
  $("#doughnutChart").drawDoughnutChart([
    { title: "Pharmacogenetics", value : 200, color: "#85b662" },
    { title: "Toxicology", value:  182, color: "#fdd400" },
    { title: "Compounding", value:  70, color: "#f4a81e" },
    { title: "Other", value : 500, color: "#1e458c" },
  ]);
});
/*!
...
/* ----- HIDING LEADS STARS ----- */
 ...
 var filterleadwidth=$('#filter-lead').width()-4;
  var listboxleadwidth=$('#listbox-lead').width();
...
if(!$('#listbox-lead').hasClass('col-lg-3')){

  $('#filter-lead').animate(
            {
               'marginLeft': '-'+filterleadwidth+'px'
            }, "slow", function() {
                $(this).hide();
...
$('#filter-toggle-btn').css("display",'block');
  }

                
                $('#filter-lead').addClass('filter-lead-hide');
              
            }
        );

  $('#lead-info-wrap').animate(
  {

'marginLeft':'-'+listboxleadwidth+'px'
...
$('#listbox-lead').css('left','0px');



$('#filter-toggle-btn').css("display",'none');
$('#filter-lead').removeClass('filter-lead-hide').show().width(filterleadwidth);
