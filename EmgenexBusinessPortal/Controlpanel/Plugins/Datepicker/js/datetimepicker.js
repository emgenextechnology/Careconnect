...
(function (factory) {
  ...
  function DatetimepickerDirective(defaultConfig, configurationValidator) {
    ...
    function DirectiveController($scope, $element, $attrs) {
      ...
      function monthModelFactory(milliseconds) {
        ...
        var activeDate = formatValue(ngModelController.$modelValue, 'MMM-YYYY');
        ...
        for (var i = 0; i < 12; i += 1) {
          ...
          var dateValue = {
            ...
            'active': monthMoment.format('MMM-YYYY') === activeDate
          };
  ...
  function DateTimePickerConfigProvider() {
    ...
    var defaultConfiguration = {
      ...
      minView: 'minute',
      modelType: 'Date',
      parseFormat: 'MM-DD-YYYY',//'YYYY-MM-DDTHH:mm:ss.SSSZZ',
      renderOn: null,
      startView: 'day'
    };
