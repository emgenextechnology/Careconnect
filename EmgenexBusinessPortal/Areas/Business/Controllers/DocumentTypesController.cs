...
namespace EmgenexBusinessPortal.Areas.Business.Controllers
{
   [BusinessAuthorize]
    public class DocumentTypesController : BaseController
    {
        ...
        {
            var lookupDocumentTypes = db.LookupDocumentTypes.Where(a=>a.BusinessId==CurrentBusinessId).Include(l => l.User).Include(l => l.User1);
            return View(lookupDocumentTypes.OrderByDescending(a=>a.CreatedOn).ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "Id,DocumentType,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy")] LookupDocumentType lookupDocumentType)
        {
            ...
            {
                lookupDocumentType.BusinessId = CurrentBusinessId;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,DocumentType,BusinessId,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy")] LookupDocumentType lookupDocumentType)
        {
            if (ModelState.IsValid)
            {
